...
surface documented in [`docs/inline-csharp-code.md`](https://github.com/wieslawsoltes/XamlToCSharpGenerator/blob/main/docs/inline-csharp-code.md).
...
See [`docs/inline-csharp-code.md`](https://github.com/wieslawsoltes/XamlToCSharpGenerator/blob/main/docs/inline-csharp-code.md) for that surface.
