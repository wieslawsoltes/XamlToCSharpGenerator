...
public sealed class AvaloniaCodeEmitter : IXamlCodeEmitter
{
    ...
    public (string HintName, string Source) Emit(ResolvedViewModel viewModel)
    {
        ...
        sourceBuilder.AppendLine("        }");
        sourceBuilder.AppendLine();
        sourceBuilder.AppendLine("        private static bool __TryResolveDictionaryEntryValue(object? ownerContext, object? value, out object? resolvedValue)");
        sourceBuilder.AppendLine("        {");
        sourceBuilder.AppendLine("            resolvedValue = value;");
        sourceBuilder.AppendLine("            if (value is global::Avalonia.Markup.Xaml.Styling.StyleInclude styleInclude)");
        sourceBuilder.AppendLine("            {");
        sourceBuilder.AppendLine("                if (__TryResolveStyleInclude(styleInclude, ownerContext, out var resolvedStyle))");
        sourceBuilder.AppendLine("                {");
        sourceBuilder.AppendLine("                    resolvedValue = resolvedStyle;");
        sourceBuilder.AppendLine("                    return true;");
        sourceBuilder.AppendLine("                }");
        sourceBuilder.AppendLine();
        sourceBuilder.AppendLine("                try");
        sourceBuilder.AppendLine("                {");
        sourceBuilder.AppendLine("                    if (styleInclude.Loaded is global::Avalonia.Styling.IStyle loadedStyle)");
        sourceBuilder.AppendLine("                    {");
        sourceBuilder.AppendLine("                        resolvedValue = loadedStyle;");
        sourceBuilder.AppendLine("                        return true;");
        sourceBuilder.AppendLine("                    }");
        sourceBuilder.AppendLine("                }");
        sourceBuilder.AppendLine("                catch");
        ...
        sourceBuilder.AppendLine("            }");
        sourceBuilder.AppendLine();
        sourceBuilder.AppendLine("            if (value is global::Avalonia.Markup.Xaml.Styling.ResourceInclude resourceInclude)");
        sourceBuilder.AppendLine("            {");
        sourceBuilder.AppendLine("                if (__TryResolveResourceInclude(resourceInclude, ownerContext, out var loadedInclude) && loadedInclude is not null)");
        sourceBuilder.AppendLine("                {");
        sourceBuilder.AppendLine("                    resolvedValue = loadedInclude;");
        sourceBuilder.AppendLine("                    return true;");
        sourceBuilder.AppendLine("                }");
        sourceBuilder.AppendLine();
        sourceBuilder.AppendLine("                try");
        sourceBuilder.AppendLine("                {");
        sourceBuilder.AppendLine("                    var loadedValue = resourceInclude.Loaded;");
        sourceBuilder.AppendLine("                    if (loadedValue is not null)");
        sourceBuilder.AppendLine("                    {");
        sourceBuilder.AppendLine("                        resolvedValue = loadedValue;");
        sourceBuilder.AppendLine("                        return true;");
        sourceBuilder.AppendLine("                    }");
        sourceBuilder.AppendLine("                }");
        sourceBuilder.AppendLine("                catch");
        ...
        sourceBuilder.AppendLine("            }");
        sourceBuilder.AppendLine();
        sourceBuilder.AppendLine("            var dictionaryValue = value;");
        sourceBuilder.AppendLine("            if (!__TryResolveDictionaryEntryValue(dictionary, value, out dictionaryValue))");
        sourceBuilder.AppendLine("            {");
        sourceBuilder.AppendLine("                dictionaryValue = value;");
        sourceBuilder.AppendLine("            }");
        sourceBuilder.AppendLine();
        ...
        sourceBuilder.AppendLine("                try");
        sourceBuilder.AppendLine("                {");
        sourceBuilder.AppendLine("                    genericMap[key] = dictionaryValue;");
        sourceBuilder.AppendLine("                }");
        sourceBuilder.AppendLine("                catch");
        sourceBuilder.AppendLine("                {");
        sourceBuilder.AppendLine("                }");
        ...
        sourceBuilder.AppendLine("                try");
        sourceBuilder.AppendLine("                {");
        sourceBuilder.AppendLine("                    map[key] = dictionaryValue;");
        sourceBuilder.AppendLine("                }");
        sourceBuilder.AppendLine("                catch");
        sourceBuilder.AppendLine("                {");
        sourceBuilder.AppendLine("                }");
