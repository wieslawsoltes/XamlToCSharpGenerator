...
public class AvaloniaXamlSourceGeneratorTests
{
    ...
    [Fact]
    public void Preserves_XType_Markup_For_NonDataType_ObjectNode_Binding_Arguments()
    {
        const string code = """
            namespace Avalonia.Data
            {
                ...
                <StackPanel>
                    <local:BindingHost>
                        <local:BindingHost.ValueBinding>
                            <data:Binding Path="Name">
                                <data:Binding.ConverterParameter>
                                    <x:Type TypeName="vm:RowVm" />
                                </data:Binding.ConverterParameter>
                            </data:Binding>
                        </local:BindingHost.ValueBinding>
                    </local:BindingHost>
        ...
        var generated = GetGeneratedPartialClassSource(updatedCompilation, "MainView");
        Assert.Contains("ValueBinding =", generated);
        Assert.Contains("typeof(global::Demo.ViewModels.RowVm)", generated);
        Assert.DoesNotContain("\"vm:RowVm\"", generated);
    }
    ...
    [Fact]
    public void Infers_ItemTemplate_DataType_From_OwnerQualified_ItemsSource_Attribute()
    {
        const string code = """
            namespace Avalonia
            {
        ...
        const string xaml = """
            <UserControl xmlns="https://github.com/avaloniaui"
                         ...
                         x:DataType="vm:MainVm"
                         x:CompileBindings="True">
                <ListBox ItemsControl.ItemsSource="{CompiledBinding Rows}">
                    <ListBox.ItemTemplate>
                        <DataTemplate>
                            <TextBlock Text="{CompiledBinding Name}" />
                        </DataTemplate>
    ...
    [Fact]
    public void Infers_ItemTemplate_DataType_From_ObjectElement_ItemsSource_Binding_PropertyElement_Path()
    {
        const string code = """
            namespace Avalonia
            {
    ...
    [Fact]
    public void Ignores_Unrelated_OwnerQualified_ItemsSource_PropertyElement_During_Inference()
    {
        const string code = """
            namespace Avalonia
            {
            ...
            namespace Demo.Attached
            {
                public static class OtherOwner
                {
                    public static readonly global::Avalonia.AttachedProperty<object?> ItemsSourceProperty = new();

                    public static object? GetItemsSource(global::Avalonia.AvaloniaObject obj) => null;

                    public static void SetItemsSource(global::Avalonia.AvaloniaObject obj, object? value)
                    {
                    }
                }
            }
            ...
            namespace Demo.ViewModels
            {
                ...
                public sealed class OtherRowVm
                {
                ...
                public sealed class MainVm
                {
                    ...
                    public global::System.Collections.Generic.IReadOnlyList<OtherRowVm> OtherRows { get; } =
                        global::System.Array.Empty<OtherRowVm>();
                }
            }
        ...
        const string xaml = """
            <UserControl xmlns="https://github.com/avaloniaui"
                         xmlns:x="http://schemas.microsoft.com/winfx/2006/xaml"
                         xmlns:local="clr-namespace:Demo.Attached"
                         xmlns:vm="clr-namespace:Demo.ViewModels"
                         x:Class="Demo.MainView"
                         x:DataType="vm:MainVm"
                         x:CompileBindings="True">
                <ListBox>
                    <local:OtherOwner.ItemsSource>
                        <CompiledBinding Path="OtherRows" />
                    </local:OtherOwner.ItemsSource>
                    <ListBox.ItemsSource>
                        <CompiledBinding Path="Rows" />
                    </ListBox.ItemsSource>
    ...
    [Fact]
    public void Infers_ItemTemplate_DataType_From_ObjectElement_ItemsSource_Binding_PropertyElement_DataType_XamlType()
    {
        const string code = """
            namespace Avalonia
            {
    ...
    [Fact]
    public void Reports_Invalid_BindingLocal_DataType_For_AssignBinding_Clr_Property_CompiledBinding()
    {
        const string code = """
            namespace Avalonia.Data
            {
        ...
        const string xaml = """
            <UserControl xmlns="https://github.com/avaloniaui"
                         ...
                         x:CompileBindings="True">
                <StackPanel>
                    <local:BindingHost ValueBinding="{CompiledBinding Name, DataType={x:Type vm:MissingVm}}" />
                </StackPanel>
            </UserControl>
            """;
        ...
        Assert.Contains(
            diagnostics,
            diagnostic => diagnostic.Id == "AXSG0110" &&
                          diagnostic.GetMessage().Contains("invalid DataType '{x:Type vm:MissingVm}'", StringComparison.Ordinal));
        Assert.DoesNotContain(
            diagnostics,
            diagnostic => diagnostic.Id == "AXSG0111" &&
                          diagnostic.GetMessage().Contains("source type 'global::Demo.ViewModels.MainVm'", StringComparison.Ordinal));
    }
