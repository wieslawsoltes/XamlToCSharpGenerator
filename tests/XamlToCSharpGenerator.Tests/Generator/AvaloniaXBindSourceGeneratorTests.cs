...
public class AvaloniaXBindSourceGeneratorTests
{
    ...
    public void Generates_XBind_Source_Options_And_Lifecycle_Surface()
    {
        const string code = """
            ...
            namespace XamlToCSharpGenerator.Runtime
            {
                public static class SourceGenMarkupExtensionRuntime
                {
                    public static T ResolveNamedElement<T>(object target, object root, string name) => default!;
                    public static T CoerceMarkupExtensionValue<T>(object value) => default!;
                    public static void InitializeXBind(object root) { }
                    public static void UpdateXBind(object root) { }
                    public static void StopTrackingXBind(object root) { }
                }
            }
            ...
            namespace Demo
            {
                ...
                {
                    public static StaticSource Current { get; } = new();
                }
        ...
        const string xaml = """
            <UserControl xmlns="https://github.com/avaloniaui"
                ...
                <StackPanel>
                    ...
                    <TextBlock Text="{x:Bind Value, Source={x:Static local:BindingSources.Current}, DataType=local:StaticSource, ConverterLanguage='pl-PL'}" />
                </StackPanel>
            </UserControl>
            """;
        ...
        var generated = GetGeneratedPartialClassSource(updatedCompilation, "MainView");
        Assert.Contains("public __SourceGenXBindBindings Bindings =>", generated);
        Assert.Contains("SourceGenBindingSourceKind.ElementName", generated);
        Assert.Contains("SourceGenBindingSourceKind.Target", generated);
        Assert.Contains("SourceGenBindingSourceKind.ExplicitSource", generated);
        Assert.Contains("global::Demo.BindingSources.Current", generated);
        Assert.Contains("\"pl-PL\"", generated);
    }

    [Fact]
    public void Generates_XBind_For_RelativeSource_DataContext_Using_Ambient_DataType()
    {
        const string code = """
            namespace Avalonia
            {
        ...
        const string xaml = """
            <UserControl xmlns="https://github.com/avaloniaui"
                         ...
                         xmlns:vm="clr-namespace:Demo.ViewModels"
                         x:Class="Demo.MainView">
                <StackPanel x:DataType="vm:MainViewModel">
                    <TextBlock Text="{x:Bind FirstName, RelativeSource={RelativeSource DataContext}}" />
                </StackPanel>
            </UserControl>
            """;
        ...
        var generated = GetGeneratedPartialClassSource(updatedCompilation, "MainView");
        Assert.Contains(
            "ProvideXBindExpressionBinding<global::Demo.ViewModels.MainViewModel, global::Demo.MainView, global::Avalonia.Controls.TextBlock>",
            generated);
        Assert.Contains("SourceGenBindingSourceKind.DataContext", generated);
    }
    ...
    [Fact]
    public void Generates_XBind_Event_Binding_With_ElementName_Source_Resolution()
    {
        const string code = """
            namespace Avalonia
            {
            ...
            namespace XamlToCSharpGenerator.Runtime
            {
                ...
                public static class SourceGenMarkupExtensionRuntime
                {
                    public static T ResolveNamedElement<T>(object target, object root, string name) => default!;
                    public static T CoerceMarkupExtensionValue<T>(object value) => default!;
                    public static bool TryResolveXBindDependency<T>(SourceGenBindingDependency dependency, object? targetObject, object? anchorObject, object? rootObject, out T value)
                    {
                        value = default!;
                        return true;
                    }
        ...
        Assert.Contains(
            generatedSources,
            static source => source.Contains("TryResolveXBindDependency<", StringComparison.Ordinal));
        Assert.Contains(
            generatedSources,
            static source => source.Contains("SourceGenBindingSourceKind.ElementName", StringComparison.Ordinal));
        Assert.Contains(
            generatedSources,
            static source => source.Contains("\"ActionButton\"", StringComparison.Ordinal));
    }

    [Fact]
    public void Generates_XBind_With_Namescope_Aware_Named_Element_Resolution()
    {
        const string code = """
            namespace Avalonia
            {
        ...
        const string xaml = """
            <UserControl xmlns="https://github.com/avaloniaui"
                ...
                <StackPanel>
                    ...
                    <TextBlock Text="{x:Bind Shared.Content}" />
                    <ItemsControl>
                        <ItemsControl.ItemTemplate>
                            <DataTemplate x:DataType="vm:ItemViewModel">
                                <StackPanel>
                                    <TextBlock x:Name="Shared" Text="{x:Bind DisplayName}" />
                                    <TextBlock Text="{x:Bind Text, ElementName=Shared}" />
                                    <TextBlock Text="{x:Bind Shared.Text}" />
                                </StackPanel>
                            </DataTemplate>
                        </ItemsControl.ItemTemplate>
                    </ItemsControl>
        ...
        Assert.Contains(
            ...
            static source => source.Contains(
                "ResolveNamedElement<global::Avalonia.Controls.Button>(target, root, \"Shared\").Content",
                StringComparison.Ordinal));
    }

    [Fact]
    public void Generates_XBind_Event_Binding_With_Root_Scope_Explicit_DataType_Source()
    {
        const string code = """
            namespace Avalonia
            {
            ...
            namespace Demo
            {
                ...
                public static class BindingSources
                {
                    public static ActionSource Current { get; } = new();
                }
        ...
        const string xaml = """
            <UserControl xmlns="https://github.com/avaloniaui"
                         ...
                         xmlns:local="clr-namespace:Demo"
                         x:Class="Demo.MainView">
                <Button Click="{x:Bind Perform(), Source={x:Static local:BindingSources.Current}, DataType=local:ActionSource}" />
            </UserControl>
            """;
        ...
        Assert.Contains(
            generatedSources,
            static source => source.Contains("BindingSources.Current", StringComparison.Ordinal));
        Assert.Contains(
            generatedSources,
            static source => source.Contains("Perform", StringComparison.Ordinal));
    }
