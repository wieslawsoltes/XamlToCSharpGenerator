...
public class DifferentialFeatureCorpusTests
{
    ...
    public void Feature_Tagged_Fixture_Has_Equivalent_Backend_Build_Diagnostics(DifferentialFixture fixture)
    {
        ...
        try
        {
            ...
            var sourceGenAssemblyPath = DifferentialBuildHarness.GetAssemblyPath(tempDir, "SourceGen", "DifferentialFeatureFixture");
            ...
            var xamlIlAssemblyPath = DifferentialBuildHarness.GetAssemblyPath(tempDir, "XamlIl", "DifferentialFeatureFixture");
