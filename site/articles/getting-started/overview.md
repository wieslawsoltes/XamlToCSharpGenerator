...
AXSG focuses on compile-time XAML translation and tooling around that compiler.

Core differentiators:

- generated C# output that can be inspected and debugged directly
- compiled binding support for regular bindings, shorthand expressions, and inline C#
