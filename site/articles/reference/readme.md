...
- you need to choose a package instead of the umbrella install
- you need to understand internal support tools that are part of the repo but not shipped as standalone packages
- you need the narrative entry point for a namespace before diving into the generated API tree
- you need to map shipped artifacts to build/runtime/editor responsibilities
