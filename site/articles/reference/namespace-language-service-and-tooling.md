...
Primary namespaces in this area include:
...
This is the shared semantic layer behind the VS Code extension, LSP host, rename propagation, inline C# editing, and in-app editor integrations.
