...
Use [Package and Assembly](package-and-assembly.md) when you need the concrete mapping from install identity to runtime assembly, targets payload, tool command, or generated API coverage.
